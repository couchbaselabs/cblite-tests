...
// define list of unique providers
...
var handler = module.exports = {
  ...
  //   'db'              :  the database to create on clients
  ...
  //   'perfdb'          :  database used for stat reporting
  ...
  doSetup: function(req, res, next){
    ...
    var opts = { gateway : gateway,
                 providers : providers,
                 gatewaydb : req.params.gatewaydb ? req.params.gatewaydb : "db"}
...
function setOptsFromParams(opts){
  ...
  perfparams.providers = opts.providers ? opts.providers : providers
