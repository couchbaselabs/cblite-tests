...
//		var liteserv = spawn(opts.path + '/run_android_liteserv.sh', [ opts.port ]);
		var liteserv =spawn('adb', [ "shell", "am start -a android.intent.action.MAIN -n com.couchbase.liteservandroid/com.couchbase.liteservandroid.MainActivity --ei listen_port", 
		                             opts.port, " --es username '' --es password ''" ]);
